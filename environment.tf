...
# Removed: aws_iam_service_linked_role resources are auto-created by AWS
# and cannot be managed by Terraform if they already exist in your account.
    ...
    policy = <<EOF
{
	...
	"Statement": [
		...
		},
		{
			...
			"Resource": "arn:aws:events:eu-north-1:821814521025:rule/triggerRate"
		}
	]
}
EOF
...
variable "alert_email" {
    description = "Email address to receive DoW alert notifications"
    type        = string
}
